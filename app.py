...
def ensure_schema_compatibility():
    ...
    updates = [
        ...
        "ALTER TABLE family_members ADD COLUMN IF NOT EXISTS can_create_campaigns BOOLEAN NOT NULL DEFAULT FALSE",
        ...
        "ALTER TABLE families ADD COLUMN IF NOT EXISTS banner_style VARCHAR(24) NOT NULL DEFAULT 'none'",
