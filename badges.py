...
BADGE_DEFINITIONS = {
    ...
    "official_organization": {"label": "Official Organization", "symbol": "◆", "tone": "organization", "explanation": "This organization was verified by RiseTogether."},
...
def user_badges(user, family=None):
    ...
    elif user.admin_role in {"moderator", "admin"} and "platform_moderator" in assigned_types:
